...
namespace Rabbit.WeiXin.Tests
{
    ...
    public class ResponseMessageFormatter
    {
        ...
        public void ResponseMessageTextTest()
        {
            ...
            Assert.Equal("<xml><ToUserName><![CDATA[chunsun]]></ToUserName><FromUserName><![CDATA[majian]]></FromUserName><CreateTime><![CDATA[1432645220]]></CreateTime><MsgType><![CDATA[Text]]></MsgType><Content><![CDATA[test]]></Content></xml>", content);
        }
        ...
        public void ResponseMessageImageTest()
        {
            ...
            Assert.Equal("<xml><ToUserName><![CDATA[chunsun]]></ToUserName><FromUserName><![CDATA[majian]]></FromUserName><CreateTime><![CDATA[1432645220]]></CreateTime><MsgType><![CDATA[Image]]></MsgType><Image><MediaId><![CDATA[123456-78901234567]]></MediaId></Image></xml>", content);
        }
        ...
        public void ResponseMessageVoiceTest()
        {
            ...
            Assert.Equal("<xml><ToUserName><![CDATA[chunsun]]></ToUserName><FromUserName><![CDATA[majian]]></FromUserName><CreateTime><![CDATA[1432645220]]></CreateTime><MsgType><![CDATA[Voice]]></MsgType><Voice><MediaId><![CDATA[123456-78901234567]]></MediaId></Voice></xml>", content);
        }
        ...
        public void ResponseMessageVideoTest()
        {
            ...
            Assert.Equal("<xml><ToUserName><![CDATA[chunsun]]></ToUserName><FromUserName><![CDATA[majian]]></FromUserName><CreateTime><![CDATA[1432645220]]></CreateTime><MsgType><![CDATA[Video]]></MsgType><Video><MediaId><![CDATA[123456-78901234567]]></MediaId><Title><![CDATA[标题]]></Title><Description><![CDATA[说明]]></Description></Video></xml>", content);
        }
        ...
        public void ResponseMessageMusicTest()
        {
            ...
            Assert.Equal("<xml><ToUserName><![CDATA[chunsun]]></ToUserName><FromUserName><![CDATA[majian]]></FromUserName><CreateTime><![CDATA[1432645220]]></CreateTime><MsgType><![CDATA[Music]]></MsgType><Music><Title><![CDATA[标题]]></Title><Description><![CDATA[说明]]></Description><MusicUrl><![CDATA[http://www.chunsun.cc/1.mp3]]></MusicUrl><HQMusicUrl><![CDATA[http://www.chunsun.cc/1-hq.mp3]]></HQMusicUrl><ThumbMediaId><![CDATA[1234567890-12345678]]></ThumbMediaId></Music></xml>", content);
        }
